...
import { AlertCircle, Loader2, Mail, ArrowLeft, CheckCircle, Sparkles } from "lucide-react"
        ...
        <div className="flex flex-col gap-3">
          <div className="flex gap-3">
            <Button 
              ...
              disabled={oauthLoading !== null || isLoading || showMagicLink}
            >
              {oauthLoading === "google" ? (
              ...
              <form onSubmit={handleMagicLink} className="flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    required
                  />
                  <Button type="submit" disabled={magicLinkLoading || !email}>
                    {magicLinkLoading ? (
